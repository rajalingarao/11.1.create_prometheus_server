...
wget https://github.com/prometheus/prometheus/releases/download/v3.11.3/prometheus-3.11.3.linux-amd64.tar.gz &>>$LOGFILE

tar -xf prometheus-3.11.3.linux-amd64.tar.gz &>>$LOGFILE
VALIDATE $? "extracted prometheus"

mv prometheus-3.11.3.linux-amd64 prometheus &>>$LOGFILE
